...
Guidance for AI coding agents (Copilot, Claude, Cursor, …) working in this repository.
...
primary deliverable is **`README.md`**. This is a documentation repository, not an application —
...
| ------------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------------------- |
| `README.md`                                                               | The list itself — the main artifact.                             | ✅                        |
...
| `agents/`, `skills/`, `hooks/`, `instructions/`, `plugins/`, `workflows/` | The maintainer's **local** AI-tooling libraries.                 | ❌ Git-ignored by design. |
...
| `npm test`       | Lint + link check — the repo's quality gate.  |
